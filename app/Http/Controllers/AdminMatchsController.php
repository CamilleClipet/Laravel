...
class AdminMatchsController extends Controller
{
  ...
  */
  public function index()
  {
    ...
    ->select('matchs.*', 'a.name as team1', 'b.name as team2','a.id as team1_id', 'b.id as team2_id', 'b.flag as flag2', 'a.flag as flag1', 'c.name as winner', 'p.stadium as placement', 's.id as stat_id')
