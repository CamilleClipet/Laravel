                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="http://127.0.0.1:8000/admin">Dashboard - Admin</a>
                                    @else
                                    <a class="dropdown-item" href="http://127.0.0.1:8000/user/allBets/{{Auth::user()->id}}">See my bets</a>
                                    @endif
                                </div>
                            </li>
                        @endguest
